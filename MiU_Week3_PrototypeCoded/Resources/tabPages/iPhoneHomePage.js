...
var backgroundView = creatingImageView("../tabsVideoImages/iPhones5s_Tab.png", 320, 190, 0, null, null, null);
    backgroundView.backgroundColor = "#fff";

if (Ti.Platform.name == "iPhone OS"){
    var macHomeVideoView = creatingWebView( "http://www.youtube.com/embed/" + "TJkmc8-eyvE" + "?fs=1&autoplay=1",false, false, false, false, 320, 190, 0, null, null, null);
...
var macTableView = creatingAwholeTableView(jsonDataObject.iPhoneObject);
